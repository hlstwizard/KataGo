...
void NeuralNet::getOutput(ComputeHandle* computeHandle,
    ...
    for(int nIdx = 0; nIdx < batchSize; nIdx++) {
        ...
        MLMultiArray *binInputs = [[MLMultiArray alloc] initWithDataPointer:(void*)rowSpatial
        ...
        MLMultiArray *globalInputs = [[MLMultiArray alloc] initWithDataPointer:(void*)rowSpatial
